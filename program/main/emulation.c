...
*/
#define CONFIG_EXAMPLE_ETH_SPI_MISO_GPIO CONFIG_EXAMPLE_ETH_PHY_RST_GPIO
#define CONFIG_EXAMPLE_ETH_SPI_MOSI_GPIO CONFIG_EXAMPLE_ETH_PHY_RST_GPIO
#define CONFIG_EXAMPLE_ETH_SPI_SCLK_GPIO CONFIG_EXAMPLE_ETH_PHY_RST_GPIO
...
{
	ESP_LOGI(TAG, "HELLO HANDLER CALLED");
